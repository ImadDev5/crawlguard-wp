...
class CrawlGuardWPPro {
    ...
    public function admin_page() {
        ...
        <div class="wrap crawlguard-admin-wrap">
            <h1><span class="dashicons dashicons-shield"></span> CrawlGuard WP Pro</h1>
            
            <h2 class="nav-tab-wrapper">
                <a href="?page=crawlguard-pro&tab=dashboard" class="nav-tab <?php echo $active_tab == 'dashboard' ? 'nav-tab-active' : ''; ?>">Dashboard</a>
                <a href="?page=crawlguard-pro&tab=bot-logs" class="nav-tab <?php echo $active_tab == 'bot-logs' ? 'nav-tab-active' : ''; ?>">Bot Detection Logs</a>
                <a href="?page=crawlguard-pro&tab=settings" class="nav-tab <?php echo $active_tab == 'settings' ? 'nav-tab-active' : ''; ?>">Settings</a>
                <a href="?page=crawlguard-pro&tab=analytics" class="nav-tab <?php echo $active_tab == 'analytics' ? 'nav-tab-active' : ''; ?>">Analytics</a>
            </h2>
            
            <div class="crawlguard-tab-content">
                <?php
                switch($active_tab) {
                    case 'dashboard':
    ...
    private function set_default_options() {
        ...
        // Also set crawlguard_options for compatibility
