...
Pay Per Crawl is a revolutionary WordPress plugin that detects AI bots crawling your website and helps you monetize that traffic. Every time an AI bot like ChatGPT, Claude, or GPTBot accesses your content, you earn revenue.
...
1. Upload the plugin files to `/wp-content/plugins/pay-per-crawl-wp-plugin/`
